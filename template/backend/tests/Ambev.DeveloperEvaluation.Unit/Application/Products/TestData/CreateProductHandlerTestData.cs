...
public static class CreateProductHandlerTestData
{
    ...
    /// </summary>
    private static readonly Faker<CreateProductCommand> createProductCommandHandlerFaker = new Faker<CreateProductCommand>()
    ...
    private static readonly Faker<CreateProductResult> createProductResultHandlerFaker = new Faker<CreateProductResult>()
        .RuleFor(u => u.Rating, f => CreateRatingHandlerTestData.GenerateValidBaseRating())
        .RuleFor(u => u.Title, f => f.Commerce.ProductName())
        .RuleFor(u => u.Description, f => f.Lorem.Word())
        .RuleFor(u => u.Category, f => f.Commerce.Categories(1).First())
    ...
    {
        var command = Substitute.ForPartsOf<CreateProductCommand>();
        command.Title = "";
        command.Price = -1;
        command.Description = "";
        command.Category = "";
    ...
    {
        return createProductResultHandlerFaker.Generate();
    }
}
